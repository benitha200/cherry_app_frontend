...
const BagOffForm = ({profile}) => {
  ...
  function get_output_items(batch_no) {
    ...
    fetch(`http://192.168.81.68:8000/api/inventoryitems/${batch_no}/`, requestOptions)
      .then((response) => response.json())
      .then((result) => {
    ...
    try {
      ...
      for (const option of options) {
        ...
        if (quantityValue > 0) {
          ...
          const response = await fetch("http://192.168.81.68:8000/api/stockinventoryoutput/", requestOptions);
  ...
  function handleCompleteClick() {
    ...
    fetch(`http://192.168.81.68:8000/api/stockinventoryupdate/${batch_no}/${comp_date}/${profile.dsplayName}/`, requestOptions)
      .then((response) => response.json())
      .then((result) => {
        console.log(result)
        if (result.message) {
  ...
  const onRowEditSave = (e) => {
    ...
    fetch(`http://192.168.81.68:8000/api/stockinventoryoutputedit/${id}/`, {
      method: 'PUT',
      headers: {
