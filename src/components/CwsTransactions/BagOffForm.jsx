...
function get_cherry_grade_outputs(cherry_grade){
    ...
    fetch("http://10.100.10.43:8000/api/inventoryoutput/", requestOptions)
...
function get_output_items(batch_no){
  ...
  fetch(`http://10.100.10.43:8000/api/inventoryitems/${batch_no}/`, requestOptions)
    .then((response) => response.json())
    .then((result) => {
    ...
    useEffect(() => {
        ...
        try {
          ...
          for (const option of options) {
            ...
            if (quantityValue > 0) {
              ...
              const response = await fetch("http://10.100.10.43:8000/api/stockinventoryoutput/", requestOptions);
      ...
      function handleCompleteClick(){
        ...
        fetch(`http://10.100.10.43:8000/api/stockinventoryupdate/${batch_no}/${comp_date}/`, requestOptions)
          .then((response) => response.json())
          .then((result) => {
            console.log(result)
            if(result.message){
      ...
      return (
        ...
        <DataTable
          ...
          onRowEditSave={(e) => {
            ...
            fetch(`http://10.100.10.43:8000/api/stockinventoryoutputedit/${id}/`, {
              method: 'PUT',
              headers: {
                'Content-Type': 'application/json',
              },
