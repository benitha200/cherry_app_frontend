...
function get_cherry_grade_outputs(cherry_grade){
    ...
    fetch("http://10.100.10.43:8000/api/cherrygradeoutput/", requestOptions)
  ...
  return () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch("http://10.100.10.43:8000/api/createinventory/", requestOptionss);
